...
const navItems = [
    {
        ...
        links: [
            { href: "/portal", label: "Portal", logo: "" },
            { href: "/dashboard/analytics", label: "Analytics", logo: "" },
            { href: "/dashboard/settings", label: "Settings", logo: "" },
        ]
    },
    {
        group: {
        ...
        links: [
            { href: "/dashboard", label: "Overview", logo: "" },
            { href: "/dashboard/analytics", label: "Analytics", logo: "" },
            { href: "/dashboard/settings", label: "Settings", logo: "" },
        ]
    },
...
export function Sidebar() {
    ...
    return (
    <aside className="bg-brand h-screen w-64 fixed left-0 px-5">
