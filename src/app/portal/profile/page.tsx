...
const iconInputClass =
  "min-w-0 flex-1 rounded-md border border-gray-200 bg-white px-3 py-2 text-sm text-gray-700 outline-none transition hover:border-brand/30 focus:border-brand focus:ring-4 focus:ring-brand/10";
  ...
  return (
    ...
    >
      <div className="mb-4 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="min-w-0">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <span className="rounded-full bg-brand/[0.08] px-2.5 py-1 text-xs font-semibold text-brand">
      ...
      <label
        ...
        className={`flex min-h-[180px] w-full cursor-pointer flex-col items-center justify-center gap-3 rounded-xl border border-dashed px-4 py-8 text-center text-sm font-medium transition ${
          isDragActive
            ...
            : "border-gray-300 bg-gray-50 text-gray-500 hover:border-brand/40 hover:bg-brand/[0.03]"
      ...
      >
        ...
        <span className="inline-flex items-center gap-1.5 rounded-full bg-brand px-3 py-1.5 text-xs font-semibold text-white shadow-sm">
