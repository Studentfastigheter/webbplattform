    ...
    <main className="flex min-h-[70svh] items-center justify-center px-6 py-16">
      <div className="w-full max-w-md text-center">
        ...
        <p className="mt-3 text-[15px] leading-relaxed text-gray-500">
          Ett oväntat fel inträffade när sidan skulle laddas. Prova igen — om
          felet kvarstår, gå tillbaka till startsidan.
        </p>
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          ...
          <Link
            href="/"
            className="rounded-full border border-gray-300 px-6 py-2.5 text-sm font-semibold text-gray-700 transition-colors hover:border-gray-400 hover:text-gray-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#004225]"
          >
            Till startsidan
          </Link>
        </div>
