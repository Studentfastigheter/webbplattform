...
export const Hero = ({ 
  ...
  return (
    <section className="relative z-10 pt-8 sm:pt-12 md:pt-16 pb-12 sm:pb-16 md:pb-20 px-4 sm:px-6 max-w-7xl mx-auto grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-20 items-center overflow-hidden bg-background">
        ...
        <div className="relative w-full max-w-[280px] sm:max-w-[400px] md:max-w-[500px] lg:max-w-[600px] h-full flex items-center justify-center">
          ...
          <div className="relative w-full max-w-[280px] sm:max-w-[360px] md:max-w-[440px] lg:max-w-[480px] bg-white rounded-2xl sm:rounded-3xl shadow-2xl border border-slate-200 p-4 sm:p-5 md:p-6 overflow-hidden">
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-3 mb-4 sm:mb-5 md:mb-6">
              {[
                { label: "Visningar", val: "25.8k", up: "+74%" },
                { label: "Klick", val: "6.4k", up: "+61%" },
                { label: "Ansökn.", val: "852", up: "+38%" }
              ].map((stat, i) => (
                <div key={i} className="bg-slate-50 p-2 sm:p-3 md:p-4 rounded-lg sm:rounded-xl border border-slate-200">
                  <div className="text-[8px] sm:text-[9px] md:text-xs font-semibold text-slate-500 mb-0.5 sm:mb-1 uppercase tracking-wide">{stat.label}</div>
                  <div className="text-sm sm:text-xl md:text-2xl font-black text-slate-900 mb-0.5 sm:mb-1">{stat.val}</div>
                  ...
                  >
                    ...
                    {i === 6 && (
                      <>
                        ...
                        <div className="absolute -top-4 sm:-top-5 md:-top-6 left-1/2 -translate-x-1/2 bg-emerald-600 text-white text-[7px] sm:text-[8px] md:text-[9px] font-bold px-1.5 sm:px-2 py-0.5 rounded-full whitespace-nowrap shadow-md">
                          Idag
                        </div>
                      </>
                    )}
