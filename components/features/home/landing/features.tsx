    ...
    <section className={`py-16 sm:py-20 lg:py-24 ${sectionClassName}`}>
      <div className="container mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <div className="grid gap-5 sm:gap-6 md:grid-cols-2 lg:gap-8">
          {features.map((f, i) => (
            <div key={`${f.title}-${i}`} className="group rounded-3xl border border-border bg-card p-5 shadow-[0_18px_50px_-42px_rgba(0,66,37,0.45)] transition-all duration-300 hover:border-primary/30 hover:shadow-2xl sm:rounded-[2rem] sm:p-7 md:p-10 lg:p-12">
