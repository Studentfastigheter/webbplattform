...
interface FileUploadDropZoneProps {
    ...
    buttonLabel?: string;
    /**
     * Extra upload button text shown on mobile.
     */
    mobileButtonSuffix?: string;
    /**
     * The drag-and-drop helper text shown on larger screens.
     */
...
export const FileUploadDropZone = ({
    ...
    mobileButtonSuffix = "and attach files",
                ...
                <div className="flex justify-center gap-1 text-center">
                    ...
                    <label htmlFor={id} className="flex cursor-pointer">
                        <Button color="link-color" size="md" isDisabled={isDisabled} onClick={() => inputRef.current?.click()}>
                            {buttonLabel} <span className="md:hidden">{mobileButtonSuffix}</span>
                        </Button>
                    </label>
