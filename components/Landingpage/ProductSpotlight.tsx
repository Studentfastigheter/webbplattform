...
export default function ProductSpotlight() {
  return (
    <section className="section bg-gradient-to-b from-white to-slate-50 text-slate-900 dark:from-slate-950 dark:to-slate-900 dark:text-white">
      {/* HÄR: Ändrat till container mx-auto px-4 md:px-8 för att matcha de andra komponenterna */}
      <div className="container mx-auto px-4 md:px-8 flex flex-col gap-10 lg:grid lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
        <Reveal variant="left">
          <div className="flex flex-col gap-4">
            <p className="eyebrow mb-2 text-brand dark:text-brand">
              Plattformen
            </p>
            ...
            <p className="text-base text-slate-600 dark:text-slate-300">
              CampusLyan samlar annonser, köer och intressehantering i ett och
              samma gränssnitt. Studenter får koll på sina chanser, medan
              bostadsbolag och privatvärdar publicerar på minuter – tryggt och
              smidigt.
            </p>
            ...
            <div className="grid gap-3 sm:gap-4">
              <div className="rounded-2xl border border-black/5 bg-white/95 p-4 text-left shadow-soft dark:border-white/10 dark:bg-slate-900/80">
                ...
                <p className="text-sm text-slate-600 dark:text-slate-300">
                  Annonser, köer och intresseanmälningar i en vy – slipp hoppa
                  mellan olika portaler.
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-black/5 bg-white/95 p-4 text-left shadow-soft dark:border-white/10 dark:bg-slate-900/80">
                ...
                <p className="text-sm text-slate-600 dark:text-slate-300">
                  Följ läget direkt: placering i kö, visningar och inkommande
                  intressen.
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-black/5 bg-white/95 p-4 text-left shadow-soft dark:border-white/10 dark:bg-slate-900/80">
                <div className="font-semibold text-slate-900 dark:text-white">
                  All info i ett flöde
                </div>
                <p className="text-sm text-slate-600 dark:text-slate-300">
                  Köregler, krav, avtal, guider, spartips och
                  ekonomigenomgångar – lättillgängligt för alla.
                </p>
              </div>

              <div className="rounded-2xl border border-black/5 bg-white/95 p-4 text-left shadow-soft dark:border-white/10 dark:bg-slate-900/80">
                <div className="font-semibold text-slate-900 dark:text-white">
                  Smidigt även för privat
                </div>
                <p className="text-sm text-slate-600 dark:text-slate-300">
                  CampusLyan guidar genom hela uthyrningen – från annons till
                  avtal – perfekt även för förstagångsuthyrare.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="rounded-2xl border border-slate-200 bg-white p-4 sm:p-5">
                <div className="flex flex-wrap items-center justify-between gap-2">
                  <p className="text-xs uppercase tracking-[0.35em] text-slate-900">
                    Mina annonser
                  </p>
                  ...
                  <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between sm:gap-3">
                    <div>
                      <p className="text-sm font-semibold">
                        1:a i Vasastan · 25 m² · 6 200 kr
                      </p>
                      <p className="text-xs text-slate-600">
                        Publicerad • Synlig för verifierade studenter
                      </p>
                    </div>
                ...
                <div className="mt-3 rounded-xl border border-slate-200 p-4">
                  <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between sm:gap-3">
                    <div>
                      <p className="text-sm font-semibold">
                        Rum i Guldheden · 14 m² · 3 900 kr
                      </p>
                      <p className="text-xs text-slate-600">
                        Utkast • Komplettera uppgifter innan publicering
                      </p>
                    </div>
              ...
              <div className="rounded-2xl border border-slate-200 bg-white p-4 sm:p-5">
                ...
                <ul className="mt-4 space-y-2 text-sm">
                  <li className="rounded-lg border border-slate-200 p-3">
                    <span>
                      <strong>Elin</strong> • Civilingenjör • Inflytt 1 jun •
                      Husdjur OK
                    </span>
                  </li>
                  <li className="rounded-lg border border-slate-200 p-3">
                    <span>
                      <strong>Victor</strong> • Masterstudent • Garanterad
                      inkomst • Rökfri
                    </span>
                  </li>
                  <li className="rounded-lg border border-slate-200 p-3">
